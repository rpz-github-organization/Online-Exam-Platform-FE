<template>
  <div>
    ...
    <ul
    v-for="(exam,index) in passExamInfo_All.slice((currentPage-1)*pageSize,currentPage*pageSize)"
    :key="index"
    class="middle">
      <li id="exam">
    ...
    <div class="page" v-if="this.passExamInfo_All.length !== 0">
      <el-pagination
...
export default {
  ...
  methods: {
    ...
    count() {
      this.totalCount = this.passExamInfo_All.length;
    },
    toDetail(examId) {
